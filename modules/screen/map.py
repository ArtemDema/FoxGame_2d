...
from ..enemy import Frog, Chicken, Rooster, Opossum, Chick
...
map = [ [" "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "],
        ...
        [" "," "," "," "," "," "," "," ","e"," "," "," "," "," "," ","f"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","i"," "," "," "," "," "," "," "," "," "," ","b"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "],
        [" "," ","b"," "," "," "," ","e","b"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","6"," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," ","7","7"," "," "," "," "," "," "],
        [" "," ","b"," ","h","s"," ","b","b","b","i"," "," "," "," "," "," ","8","r"," "," "," ","h"," "," ","f"," "," ","8"," "," "," "," ","s","f"," "," "," "," "," "," "," ","8","f"," "," "," "," "," "," "," ","s"," "," ","r"," "," "," ","8"," ","b"," "," ","s","h"," "," ","b"," "," "," ","b","7","8"," ","f","c"," "," ","r"," ","e","b","b","6"," ","s","h","n"," "," "],
...
for idy, row in enumerate(map):
    for idx, column in enumerate(row):       
        if column == "8":
            ...
            rooster = Rooster(50 * idx, 50 * idy - 14, 63, 65, "images/enemy/rooster/idle/0.png", 3, 2, 0, 0, False, 0)
            ...
            chick = Chick(50 * idx, 50 * idy, 25, 34, "images/resources/egg.png", 3, 2.2, 2, False, 0)
            list_chick.append(chick)
            list_enemy.append(chick)
