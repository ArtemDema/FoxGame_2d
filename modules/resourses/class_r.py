...
meat1 = Discarded_Item(x = 600, y = 200, width = 50, height = 25, image = "images/resources/meat.png", whatIsThis= "meat")
egg1 = Discarded_Item(x = 700, y = 200, width = 20, height = 30, image = "images/resources/egg.png",whatIsThis= "egg")
