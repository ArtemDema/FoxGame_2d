...
#### Ось кусочок з коду, з демонстраціею як це працює:
```python
if keys[pygame.K_a]:
...
---
### Frog
#### Поведінка жаби - агресивна, може стрибати. Ось кусочок з коду, з демонстраціею як це працює:
```python
#стрибок
...
---
### Chick
#### Поведінка курча - агресивна, може бігати. Ось кусочок з коду, з демонстраціею як це працює:
```python
#біг
...
---
### Chicken
#### Поведінка куриці - полохлива, може бігати. Ось кусочок з коду, з демонстраціею як це працює:
```python
#пугливість
...
---
### Rooster
#### Поведінка півня - агресивна, може бігати. Ось кусочок з коду, з демонстраціею як це працює:
```python
#біг
for block in list_of_all_blocks: #CHECK TOUCH LEFT WALL OF BLOCK
    answer = block.check_collision_left_wall(chick.x, chick.y, 
...
---
### Water
#### Вода наносить шкоду гравцю. Ось кусочок з коду, з демонстраціею як це працює:
```python
...
Розробивши цю гру я отримав і вдосконалив навички розробки ігор на модулі pygame. 
...
Хоч проект ще можно доробити, наприклад розробити ще рівнів, все одно він вже гідний для демонстрації,
