...
#### Ось кусочок с коду, з демонстраціей як це працює:
```python
if keys[pygame.K_a]:
...
#### Ось кусочок з коду, з демонстраціей як це працює:
```python
...
#### якщо ця клавіша натиснута, то гра сповільнюеться і з'являються дві кнопки(виходу та продовження) 
#### Ось кусочок з коду, з демонстраціей як це працює:
```python
...
---
### Frog
#### Поведінка жаби - агресивна, може стрибати. Ось кусочок з коду, з демонстраціей як це працює:
```python
#стрибок
...
---
### Chick
#### Поведінка курча - агресивна, може бігати. Ось кусочок с коду, з демонстраціей як це працює:
```python
#біг
...
---
### Chicken
#### Поведінка куриці - полохливий, може бігати. Ось кусочок с коду, з демонстраціей як це працює:
```python
#пугливість
...
---
### Rooster
#### Поведінка півня - агресивна, може бігати. Ось кусочок с коду, з демонстраціей як це працює:
```python
#біг
for block in list_of_all_blocks: #CHECK TOUCH LEFT WALL OF BLOCK
    answer = block.check_collision_left_wall(chick.x, chick.y, 
...
---
### Feather
#### З'являється коли півень бачить ігрока. Летить в напрямок ігрока.
#### Ось кусочок з коду, з демонстраціей як це працює:
```python
#поява
...
---
### Water
#### Вода наносить урон ігроку. Ось кусочок з коду, з демонстраціей як це працює:
```python
...
Також в процесі розробки гри я познайомився з TileMapEditor, який допомогає розробити статичну частину мапи.
